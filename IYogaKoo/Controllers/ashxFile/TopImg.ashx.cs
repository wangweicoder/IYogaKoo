...
namespace IYogaKoo.Controllers.ashxFile
{
    ...
    /// TopImg 的摘要说明
    /// </summary>
    public class TopImg : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                string FileServerPathTask = HttpContext.Current.Server.MapPath("~") + "/Files/avatar/original";
                ...
                if (FileServerPathTask != null)
                {
                    ...
                    else
                    {
                        ...
                        context.Response.Write("Files/avatar/original/" + filename + fileExt);
