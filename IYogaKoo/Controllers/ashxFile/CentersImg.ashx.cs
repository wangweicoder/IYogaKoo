...
namespace IYogaKoo.Controllers.ashxFile
{
    ...
    /// CoverFile 的摘要说明
    /// </summary>
    public class CentersImg : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                string FileServerPathTask = HttpContext.Current.Server.MapPath("~") + "/Files/Centers";
                ...
                if (FileServerPathTask != null)
                {
                    ...
                    else
                    {
                        ...
                        context.Response.Write("Files/Centers/" + filename + fileExt);
                    }
                }
                else
                {
