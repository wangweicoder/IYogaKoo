...
namespace IYogaKoo.Controllers.ashxFile
{
    ...
    /// TeachApplyImg 的摘要说明
    /// </summary>
    public class TeachApplyImg : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                string FileServerPathTask = HttpContext.Current.Server.MapPath("~") + "/Files/TeachApply";
                ...
                if (FileServerPathTask != null)
                {
                    ...
                    else
                    {
                        ...
                        context.Response.Write("Files/TeachApply/" + filename + fileExt);
                    }
                }
                else
                {
