$(function () {
    ...
    $("#add-teacherOfYogisModels").click(function () {
        ShowBox('/manage/class/Create', "添加上课导师", null, '1000px', function () {
            var setting = uploadifySetting;
            setting.onUploadSuccess = function (file, data, response) {
                if (response) {
                    $('#add-class-teacher #Avatar').val(data);
        ...
        //art.dialog.open('/manage/class/Create', {
        //    title: '添加上课导师',
        //    lock: true,
        //    width: 1000,
        //    hight: 600,
    ...
    $(function () {
        $("#turn-teacher").click(function () {
            window.location = '/Manage/Member/DaoShiCreate';
        });
    });
});
//common
...
function ShowBox(url, title, param, callback) {
    //if (width == undefined) width = '660px';
    Loading();
