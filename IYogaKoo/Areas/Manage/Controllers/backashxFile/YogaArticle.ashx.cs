...
namespace IYogaKoo.Areas.Manage.Controllers.backashxFile
{
    ...
    /// YogaArticle 的摘要说明
    /// </summary>
    public class YogaArticle : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                string FileServerPathTask = HttpContext.Current.Server.MapPath("~") + "/Files/YogaArticle";
                ...
                if (FileServerPathTask != null)
                {
                    ...
                    else
                    {
                        ...
                        context.Response.Write("Files/YogaArticle/" + filename + fileExt);
                    }
                }
                else
                {
