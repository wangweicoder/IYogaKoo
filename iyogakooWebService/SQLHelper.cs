...
namespace iyogakooWebService
{
    public static class SQLHelper
    {
        ...
        public static void WriteTextLogSuccess(string actionName, string errorMessage)
        {
            try
            {
                string path = "~/ErrorLog/Success_log" + DateTime.Today.ToString("yyMMdd") + ".txt";
            ...
            {
                WriteTextLogSuccess(actionName, ex.Message);
            }
        }
        /// <summary>
        /// 失败
        ...
        /// <param name="actionName"></param>
        /// <param name="errorMessage"></param>
        public static void WriteTextLogFail(string actionName, string errorMessage)
        {
            try
            {
                string path = "~/ErrorLog/Fail_logl" + DateTime.Today.ToString("yyMMdd") + ".txt";
                if (!File.Exists(System.Web.HttpContext.Current.Server.MapPath(path)))
                {
                    File.Create(System.Web.HttpContext.Current.Server.MapPath(path)).Close();
                }
            ...
            {
                WriteTextLogFail(actionName, ex.Message);
            }
        }
    }
}
